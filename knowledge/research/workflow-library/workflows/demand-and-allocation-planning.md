# Demand and Allocation Planning
...
- Industries using this workflow: `Computer and electronic products`
- Industry count: 1
- Systems-of-record categories: `Manufacturing Execution System | Supply Chain Planning | PLM and Engineering Design | ERP`
...
- Systems of record involved: Manufacturing Execution System | Supply Chain Planning | PLM and Engineering Design | ERP
...
- What software exists today: Typical stacks combine Manufacturing Execution System, Supply Chain Planning, PLM and Engineering Design, ERP; representative software in market today includes Siemens Opcenter, Rockwell FactoryTalk MES, Plex, Epicor, Rockwell FactoryTalk, Blue Yonder Integrated Business Planning.
...
- Why this has not been solved cleanly: The hard problem is not math alone; it is aligning noisy signals, local constraints, and organizational trust. It typically spans 1 operating-system context and 4 systems-of-record categories.
